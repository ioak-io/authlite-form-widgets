export type TranslationDictionary = {
  ...
  RESET_PASSWORD_FORM__LABEL_PASSWORD: string;
  RESET_PASSWORD_FORM__LABEL_RETYPEPASSWORD: string;
  RESET_PASSWORD_FORM__GREETING_TITLE: string;
  RESET_PASSWORD_FORM__GREETING_SUBTITLE: string;
  RESET_PASSWORD_FORM_ERROR__INVALID_CODE: string;
  RESET_PASSWORD_FORM_ERROR__BAD_REQUEST: string;
  RESET_PASSWORD_FORM_ERROR__UNKNOWN_ERROR: string;
  RESET_PASSWORD_FORM__ACTION_CHANGE_PASSWORD: string;

  CONFIRM_EMAIL_LINK__GREETING_TITLE: string;
  CONFIRM_EMAIL_LINK__GREETING_SUBTITLE: string;
  CONFIRM_EMAIL_LINK_ERROR__INVALID_CODE: string;
  CONFIRM_EMAIL_LINK_ERROR__BAD_REQUEST: string;
  CONFIRM_EMAIL_LINK_ERROR__UNKNOWN_ERROR: string;

  MYPROFILE_FORM__ACTION_UPDATE_PROFILE: string;
  MYPROFILE_FORM__LABEL_AVATAR: string;
...
export enum TranslationName {
  ...
  RESET_PASSWORD_FORM__LABEL_PASSWORD = "RESET_PASSWORD_FORM__LABEL_PASSWORD",
  RESET_PASSWORD_FORM__LABEL_RETYPEPASSWORD = "RESET_PASSWORD_FORM__LABEL_RETYPEPASSWORD",
  RESET_PASSWORD_FORM__ACTION_CHANGE_PASSWORD = "RESET_PASSWORD_FORM__ACTION_CHANGE_PASSWORD",

  RESET_PASSWORD_FORM__GREETING_TITLE = "RESET_PASSWORD_FORM__GREETING_TITLE",
  RESET_PASSWORD_FORM__GREETING_SUBTITLE = "RESET_PASSWORD_FORM__GREETING_SUBTITLE",
  RESET_PASSWORD_FORM_ERROR__INVALID_CODE = "RESET_PASSWORD_FORM_ERROR__INVALID_CODE",
  RESET_PASSWORD_FORM_ERROR__BAD_REQUEST = "RESET_PASSWORD_FORM_ERROR__BAD_REQUEST",
  RESET_PASSWORD_FORM_ERROR__UNKNOWN_ERROR = "RESET_PASSWORD_FORM_ERROR__UNKNOWN_ERROR",

  CONFIRM_EMAIL_LINK__GREETING_TITLE = "CONFIRM_EMAIL_LINK__GREETING_TITLE",
  CONFIRM_EMAIL_LINK__GREETING_SUBTITLE = "CONFIRM_EMAIL_LINK__GREETING_SUBTITLE",
  CONFIRM_EMAIL_LINK_ERROR__INVALID_CODE = "CONFIRM_EMAIL_LINK_ERROR__INVALID_CODE",
  CONFIRM_EMAIL_LINK_ERROR__BAD_REQUEST = "CONFIRM_EMAIL_LINK_ERROR__BAD_REQUEST",
  CONFIRM_EMAIL_LINK_ERROR__UNKNOWN_ERROR = "CONFIRM_EMAIL_LINK_ERROR__UNKNOWN_ERROR",

  MYPROFILE_FORM__ACTION_UPDATE_PROFILE = "MYPROFILE_FORM__ACTION_UPDATE_PROFILE",
  MYPROFILE_FORM__LABEL_AVATAR = "MYPROFILE_FORM__LABEL_AVATAR"
}
...
export const DEFAULT_TRANSLATION_DICTIONARY: TranslationDictionary = {
  ...
  SIGNIN_FORM__GREETING_SUBTITLE:
    "Metus dui sapien phasellus arcu posuere eu adipiscing proin adipiscing mi luctus dignissim sem. hendrerit dapibus ut scelerisque tellus malesuada scelerisque vel est fermentum nullam sociosqu.",
  ...
  SIGNUP_FORM__GREETING_SUBTITLE:
    "Join the community of secure authentication and authorization providers.",
  ...
  RESEND_VERIFY_LINK_FORM__GREETING_SUBTITLE:
    "Haven't received a confirmation link to confirm your user account? Enter your registered email address and we will send you another email confirmation link.",
  ...
  RESET_PASSWORD_FORM__LABEL_PASSWORD: "Password",
  RESET_PASSWORD_FORM__LABEL_RETYPEPASSWORD: "Retype Password",

  RESET_PASSWORD_FORM__GREETING_TITLE: "Reset Password",
  RESET_PASSWORD_FORM__GREETING_SUBTITLE: "Validating reset password link",
  RESET_PASSWORD_FORM_ERROR__INVALID_CODE: "Invalid password reset link",
  RESET_PASSWORD_FORM_ERROR__BAD_REQUEST: "Bad request",
  RESET_PASSWORD_FORM_ERROR__UNKNOWN_ERROR: "Unknown error",
  RESET_PASSWORD_FORM__ACTION_CHANGE_PASSWORD: "Update password",

  CONFIRM_EMAIL_LINK__GREETING_TITLE: "Confirm Email",
  CONFIRM_EMAIL_LINK__GREETING_SUBTITLE: "Validating email verification link",
  CONFIRM_EMAIL_LINK_ERROR__INVALID_CODE: "Invalid email confirmation link",
  CONFIRM_EMAIL_LINK_ERROR__BAD_REQUEST: "Bad request",
  CONFIRM_EMAIL_LINK_ERROR__UNKNOWN_ERROR: "Unknown error",

  MYPROFILE_FORM__ACTION_UPDATE_PROFILE: "Update profile",
  MYPROFILE_FORM__LABEL_AVATAR: "Profile picture"
};
